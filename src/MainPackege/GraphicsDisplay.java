...
// Перо для рисования графика
        graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT,
                BasicStroke.JOIN_ROUND, 10.0f, new float[]{1, 1, 1, 1, 1, 1, 3, 1, 2, 1, 2}, 0.0f);
...
// Сохранить массив точек во внутреннем поле класса
        this.graphicsData =  new Double[11][];
        int i = 0;
        for (Double[] el : graphicsData){
            this.graphicsData[i] = el.clone();
            i++;
        }
...
// Шаг 9 - Восстановить старые настройки холста
    ...
    public void turnGraphics(){
            for (int i = 0; i < graphicsData.length; i++) {
                ...
                graphicsData[i][0] = x * Math.cos(Math.toRadians(90)) - y * Math.sin(Math.toRadians(90));
                graphicsData[i][1] = x * Math.sin(Math.toRadians(90)) + y * Math.cos(Math.toRadians(90));
            }
    }
...
// Если  целая часть значения функции нечётная, то маркер синий
...
// Шаг 2 - Организовать цикл по всем точкам графика
            ...
            triangle.lineTo(triangle.getCurrentPoint().getX() + 5.5, triangle.getCurrentPoint().getY() - 15);
            triangle.lineTo(triangle.getCurrentPoint().getX() - 5.5, triangle.getCurrentPoint().getY() - 15);
            triangle.lineTo(triangle.getCurrentPoint().getX() - 5.5, triangle.getCurrentPoint().getY() + 15);
            triangle.closePath();
