...
//            }
//        };
        shapeRotateAntiClockItem = new JCheckBoxMenuItem("Поворот графика на 90 градусов");
        shapeRotateAntiClockItem.addActionListener(e -> {
            if (shapeRotateAntiClockItem.getState())
                display.setClockRotate(shapeRotateAntiClockItem.getState());
            else {
                display.setClockRotate(shapeRotateAntiClockItem.getState());
